...
const Header = () => {
  return (
    ...
    <div>
      <div class="Topbar-titleAndBreadcrumbs">
        <div class="Topbar-titleRow ">
          ...
          <div class="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton PageHeaderDropdownMenuButton " role="button" tabindex="0" aria-haspopup="menu" aria-label="Show options" aria-expanded="false">
          ...
          <div class="Topbar-icons">
            <div class="btn--isEnabled btn btn--medium SubtleFavoriteStarButton--favorited SubtleFavoriteStarButton SubtleFavoriteStarButton--colorAqua " role="button" tabindex="0" aria-label="Remove from favorites">
          ...
          <div class="Topbar-titleRightElement ">
      ...
      <nav className="NavBar " aria-labelledby="lui_31">
        <ul className="NavBar-list NavBar-list--defaultTabWidth">
          <li className="NavBarItem NavBar-tab">
            <a aria-current="false" className="NavBarItem-link BaseLink" href="/">
          ...
          <li className="NavBarItem NavBar-tab">
            <a aria-current="true" className="NavBarItem-link BaseLink" href="">
              <span className="NavBarItem-selectableTabContainer">
      ...
      <div className="sidebar " style={{ "padding-top": "12px", "height": "1369px" }}>
          ...
          <div className="SortableList-itemContainer SortableList-itemContainer--column">
            <div className="SortableList-sortableItemContainer">
              <div className="SortableItem SortableList-sortableItem">
                <div className="TaskTimelineGroupSidebarGroup TaskTimelineGroupSidebarGroup--isOneRow sidebar-group" style={{ "height": "40px" }}>
                  <div className="TimelineGroupWithNamesSidebar-content TaskTimelineGroupSidebarGroup-content">
                    <div className="TimelineGroupHeader TimelineGroupHeader--draggable TimelineGroupHeader--showDragIcon" draggable="true">
                      ...
                      <div className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton" role="button" tabIndex={0} aria-label="Expand task list for the section To do">
                      ...
                      <div className="TimelineGroupHeader-headerContainer">
                        ...
                        <div id="lui_868" className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton" role="button" tabIndex={0} aria-label="Show options" aria-expanded="false">
                ...
                <div className="TaskTimelineGroupSidebarGroup TaskTimelineGroupSidebarGroup--isOneRow sidebar-group" style={{ "height": "40px" }}>
                  <div className="TimelineGroupWithNamesSidebar-content TaskTimelineGroupSidebarGroup-content">
                    <div className="TimelineGroupHeader TimelineGroupHeader--draggable" draggable="true">
                      ...
                      <div className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton" role="button" tabIndex={0} aria-label="Collapse task list for the section Doing">
                      ...
                      <div className="TimelineGroupHeader-headerContainer">
                        ...
                        <div id="lui_938" className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton" role="button" tabIndex={0} aria-label="Show options" aria-expanded="false">
                          <svg className="Icon MoreIcon" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
                            <path d="M16,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S14.3,13,16,13z M3,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S1.3,13,3,13z M29,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S27.3,13,29,13z">
                            </path>
                          </svg>
                ...
                <div className="TaskTimelineGroupSidebarGroup TaskTimelineGroupSidebarGroup--isOneRow sidebar-group" style={{ "height": "40px" }}>
                  <div className="TimelineGroupWithNamesSidebar-content TaskTimelineGroupSidebarGroup-content">
                    <div className="TimelineGroupHeader TimelineGroupHeader--draggable" draggable="true">
                      ...
                      <div className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-toggleButton" role="button" tabIndex={0} aria-label="Expand task list for the section Done">
                        <svg className="Icon RightTriangleIcon" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
                          <path d="M13.707,6.707L23,16l-9.293,9.293C13.077,25.923,12,25.477,12,24.586V7.414C12,6.523,13.077,6.077,13.707,6.707z">
                          </path>
                        </svg>
                      ...
                      <div className="TimelineGroupHeader-headerContainer">
                        ...
                        <div id="lui_888" className="btn--isEnabled btn btn--medium SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton SubtleIconButton--standardTheme SubtleIconButton TimelineGroupHeader-dropdownButton" role="button" tabIndex={0} aria-label="Show options" aria-expanded="false">
                          <svg className="Icon MoreIcon" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
                            <path d="M16,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S14.3,13,16,13z M3,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S1.3,13,3,13z M29,13c1.7,0,3,1.3,3,3s-1.3,3-3,3s-3-1.3-3-3S27.3,13,29,13z">
                            </path>
                          </svg>
        ...
        <div className="ItemListAddSectionButton--large ItemListAddSectionButton sidebar-addSectionButton" role="button" tabIndex={0}>
